...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(App\Http\Controllers\EventController::class)->group(function () {
        Route::delete('/event/massDestroy', 'massDestroy')->name('event.massDestroy');
        Route::get('/event/getAlikes', 'getAlikes')->name('event.getAlikes');

        Route::resource('/event', App\Http\Controllers\EventController::class)->except(['destroy']);
    });
    ...
    Route::controller(App\Http\Controllers\SalesController::class)->group(function () {
        ...
        Route::resource('/sales', App\Http\Controllers\SalesController::class)->except(['destroy']);
    });
    /* ------------------------------------------------------------------------ */
});
